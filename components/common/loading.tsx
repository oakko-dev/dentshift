...
function LoadingComponent(props: LoadingProps): JSX.Element {
	return (
		<div>
			<svg
				aria-hidden="true"
				className={cn(`h-14 w-14`, "inline animate-spin fill-primary text-gray-200", props.className)}
				viewBox="0 0 100 101"
				fill="none"
			...
			{!props.fullscreen
				...
				: (
						<Dialog.Root defaultOpen={true}>
							<Dialog.Portal>
								<Dialog.Overlay className="pointer-events-none fixed inset-0 z-9999 bg-black/60 backdrop-blur-sm" />
								<Dialog.Content
